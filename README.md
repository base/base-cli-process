...
* [base-cli](https://www.npmjs.com/package/base-cli): base-methods plugin that adds a `config` method for mapping declarative configuration values to other 'base'… [more](https://www.npmjs.com/package/base-cli) | [homepage](https://github.com/node-base/base-cli)
* [base-cli-schema](https://www.npmjs.com/package/base-cli-schema): Schema for the base-cli plugin, used for normalizing config values before passing them to config.process(). | [homepage](https://github.com/jonschlinkert/base-cli-schema)
